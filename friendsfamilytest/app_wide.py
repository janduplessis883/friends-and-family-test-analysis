...
with col2:
    ...
    sns.barplot(
        data=monthly_count_filtered_df, x="Month", y="Monthly Count", color=hex_codes[3]
    )
    ...
    st.pyplot(fig)
with col3:
    st.metric("Total Responses", str(filtered_data.shape[0]))
order = [
    "Extremely likely",
    "Likely",
...
palette = {
    "Extremely likely": hex_codes[0],
    "Likely": hex_codes[1],
    "Neither likely nor unlikely": hex_codes[2],
    "Unlikely": hex_codes[3],
    "Extremely unlikely": hex_codes[4],
    "Don't know": hex_codes[5],
}
